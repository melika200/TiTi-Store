...
function App() {
  const information = [
    ...
    },
    {
      ...
      buttonText: "Info",
      additionalInfo: "Detailed information about the Brand of company.BRND is a female-founded Australian brand focused on empowering women by helping them feel comfortable and confident in their bodies. They aim to create engaging and meaningful brand experiences by understanding and connecting with their customers.",
    },
  ];
